...
Every number on this page comes from the same scene: an SO-ARM100 and a 30 mm cube.
Rather than describe it, here it is. A scripted pick-up in five stages, from the scene
camera.
